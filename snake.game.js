...
(function () {
    ...
    const COLOR = {
        ...
        snakeHead:   '#06b6d4',
        snakeBody:   '#0e7490',
        snakeGlow:   'rgba(6,182,212,0.35)',
        food:        '#22d3ee',
        foodGlow:    'rgba(34,211,238,0.6)',
        foodText:    '#67e8f9',
        wallHit:     '#ef4444',
        scoreFlash:  '#06b6d4',
    };
    ...
    // ── STATE ────────────────────────────────────
    let snake, dir, nextDir, food, score, highScore, speed, gameLoop, lives, gameState;
    ...
    function drawSnake() {
        snake.forEach((seg, i) => {
            ...
            if (isHead) {
                ctx.shadowBlur  = 12;
                ctx.shadowColor = COLOR.snakeGlow;
            ...
            if (isHead) {
                ...
                const ex = dir.x === 0 ? [-3, 3] : [dir.x > 0 ? 4 : -4, dir.x > 0 ? 4 : -4];
                const ey = dir.y === 0 ? [-3, 3] : [dir.y > 0 ? 4 : -4, dir.y > 0 ? 4 : -4];
    ...
    function drawIdleScreen() {
        ...
        demoSnake.forEach((seg, i) => {
            ...
            ctx.fillStyle = i === 0 ? COLOR.snakeHead : `rgba(14,116,144,${0.2 + 0.6*t})`;
